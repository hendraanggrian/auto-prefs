...
/**
 * Interface used for modifying values in a [ReadablePreferences] object. All changes you make in an
 * editor are batched, and not copied back to the original [ReadablePreferences] until you
 * call [save].
 */
