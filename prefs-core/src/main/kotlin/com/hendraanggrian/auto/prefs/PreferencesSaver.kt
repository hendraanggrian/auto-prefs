...
/**
 * Interface used for applying changes made in [PreferencesEditor] object. When
 * using `ReadablePreferences.bind` to inject preferences' values to JVM
...
interface PreferencesSaver {
    ...
    /**
     * Commit your preferences changes back from [PreferencesEditor] to the [ReadablePreferences]
     * object it is editing. This atomically performs the requested modifications, replacing
     * whatever is currently in the [ReadablePreferences].
     */
    fun save()
}
