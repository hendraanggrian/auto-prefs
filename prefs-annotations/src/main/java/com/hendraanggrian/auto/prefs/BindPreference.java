...
/**
 * Bind a preference value to JVM field with this annotation. Keep in mind that in order to use this
 * feature, `prefs-compiler` must be imported as annotation processor.
 */
