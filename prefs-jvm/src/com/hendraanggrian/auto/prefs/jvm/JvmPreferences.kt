...
class JvmPreferences internal constructor(private val nativePreferences: Preferences) :
    ...
    override fun putBoolean(key: String, value: Boolean): Unit = nativePreferences.putBoolean(key, value)
    ...
    override fun putDouble(key: String, value: Double): Unit = nativePreferences.putDouble(key, value)
    override fun getDouble(key: String, def: Double): Double = nativePreferences.getDouble(key, def)
    override fun putByteArray(key: String, value: ByteArray?): Unit = nativePreferences.putByteArray(key, value)
